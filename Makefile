...
# Zel
DEFINES   += COIN_P2PKH_VERSION=7352 COIN_P2SH_VERSION=7357 COIN_FAMILY=1 COIN_COINID=\"Zel\" COIN_COINID_HEADER=\"ZEL\" COIN_COLOR_HDR=0x183C87 COIN_COLOR_DB=0x46639F COIN_COINID_NAME=\"Zel\" COIN_COINID_SHORT=\"ZEL\" COIN_KIND=COIN_KIND_ZEL
APPNAME ="Zel"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
